...
class MainLogin extends Template implements ActionListener,Runnable
{
	...
	MainLogin()
	{
		...
		TopLabel.setText("Packer_UnPacker: Login");
		TopLabel.setForeground(Color.BLUE);
		
		Dimension topsize =TopLabel.getPreferredSize();
		TopLabel.setBounds(100,30,topsize.width,topsize.height);
		...
		label1.setBounds(100,135,size.width,size.height);
		...
		label2.setBounds(50,175,tsize.width,tsize.height);
		...
		SUBMIT.setBounds(70,220,ssize.width+3,ssize.height );
		label3 = new JLabel();
		label3.setText("");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(ae.getSource()==SUBMIT)
		{
			if(Validate(value1,value2) == false)
			{
				...
				text2.setText("");
				JOptionPane.showMessageDialog(this, "Short username","Packer_Unpacker", JOptionPane.ERROR_MESSAGE);
			}
			if (value1.equals("AdminLogin") && value2.equals("Admin@123"))
			{
